...
function replaceRequired(label, before, after) {
  if (!source.includes(before)) throw new Error(`V14 physics patch failed: ${label}`);
...
const keeperImport = `import { keeperForStage } from "${new URL("./keepers-v14.js?v=32.2", import.meta.url).href}";`;
replaceRequired(
  "ability imports",
...
source += "\n//# sourceURL=football-lab-physics-v14-generated.js\n";
