...
const renderReplacement = `new URL("${new URL("./render-v17.js?v=17", import.meta.url).href}").href`;
if (!source.includes(renderNeedle)) {
  throw new Error("V17 game-flow patch failed: V15 renderer URL not found");
}
...
source += "\n//# sourceURL=football-lab-main-v17-generated.js\n";
