...
const renderReplacement = `new URL("${new URL("./render-v17-1.js?v=171", import.meta.url).href}").href`;
if (!source.includes(renderNeedle)) {
  throw new Error("V17.1 game-flow patch failed: V15 renderer URL not found");
}
