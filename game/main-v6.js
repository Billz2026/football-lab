...
import { resolveShotPhysics } from "./physics-v6.js?v=6";
import { resizeCanvas, drawScene } from "./render-v6.js?v=6";
import { unlockAudio, playResultSound } from "./audio-v6.js?v=6";
...
function finishShot(animationId) {
  ...
  setPhase("result");
  const resultDelay = ["POST", "BAR", "WALL", "SAVE"].includes(shot.outcome) ? 1800 : 1550;
