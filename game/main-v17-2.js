...
const renderReplacement = `new URL("${new URL("./render-v17-2.js?v=172", import.meta.url).href}").href`;
if (!source.includes(renderNeedle)) {
  throw new Error("V17.2 game-flow patch failed: V15 renderer URL not found");
}
...
source += "\n//# sourceURL=football-lab-main-v17-2-generated.js\n";
