...
import { GOAL, ballWorld, keeperWorld } from "./world-v7.js?v=7";
import { difficultyForStage } from "./difficulty-v9.js?v=9";
import { activeCharacter, characterPhysics } from "./characters-v13.js?v=13";
import { keeperForStage, wallForStage, buildWallLayout } from "./lab-matchups-v15-3.js?v=153";
...
function outcomeReason(shot, wallAnalysis, keeperPlan, target) {
  if (shot.outcome === "WALL") {
    if (wallAnalysis.lane === "UNDER") return "Low trajectory did not pass beneath the airborne wall.";
    return wallAnalysis.lane === "OVER"
      ? "Trajectory did not clear the jumping wall."
      : "Shot intersected the outside wall player.";
  }
