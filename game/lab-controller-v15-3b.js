import {
  ...
  idealPower, currentAimTarget, renderHud, strikeQualityLabel
} from "./core-v6.js?v=7";
...
function takeShot() {
  ...
  state.presentation = { phase: "flight", startedAt, outcome: state.shot.outcome };
  state.animation = {
    ...
    flightDuration,
    settleDuration: settleDuration(state.shot.outcome),
    totalDuration: 560 + 64 + flightDuration + settleDuration(state.shot.outcome),
    impactPlayed: false,
    isReplay: false
  };
  state.finishedAnimationId = null;
