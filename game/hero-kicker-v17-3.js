import { clamp, lerp, WORLD, state, ctx, canvasView, easeInOutCubic, easeOutCubic } from "./core-v6.js?v=7";
import { buildCamera, kickerWorld, ballWorld } from "./world-v7.js?v=7";
import { projectedHeight, projectWorld } from "./projection-v6.js?v=7";
