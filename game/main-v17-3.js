...
const renderReplacement = `new URL("${new URL("./render-v17-3.js?v=173", import.meta.url).href}").href`;
if (!source.includes(renderNeedle)) {
  throw new Error("V17.3 game-flow patch failed: V15 renderer URL not found");
}
...
source += "\n//# sourceURL=football-lab-main-v17-3-generated.js\n";
