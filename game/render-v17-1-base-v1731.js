...
const replacements = [
  ...
  [
    'new URL("./characters-v13.js?v=32.2", import.meta.url)',
    `new URL("${absolute("./characters-v13.js?v=32.2")}")`
  ],
  [
    'new URL("./keepers-v14.js?v=32.2", import.meta.url)',
    `new URL("${absolute("./keepers-v14.js?v=32.2")}")`
  ],
  [
    'new URL("./walls-v15.js?v=32.2", import.meta.url)',
    `new URL("${absolute("./walls-v15.js?v=32.2")}")`
  ]
];
