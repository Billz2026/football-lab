const loaderSourceUrl = new URL("./render-v15-base.js?v=15", import.meta.url);
...
loaderSource = loaderSource
  .replaceAll("./keepers-v14.js?v=14", "./lab-matchups-v15-3.js?v=153")
  .replaceAll("./walls-v15.js?v=15", "./lab-matchups-v15-3.js?v=153");

loaderSource = loaderSource.replace(
  /new URL\("(\.\/[^"\n]+)"\s*,\s*import\.meta\.url\)/g,
  (_, specifier) => `new URL("${new URL(specifier, loaderSourceUrl).href}")`
);
loaderSource += "\n//# sourceURL=football-lab-render-v15-3-base-loader-generated.js\n";
