/* Football Lab Manager — career integrity runtime v1
 * Runtime safeguards, manager identity, board logic, player profiles and full-time continuity.
 */
...
import './appointment-intro-compat-v2.js?v=2.0.0';
import './appointment-modal-state-guard-v1.js?v=1.0.0';
import './shared-modal-ownership-v1.js?v=1.0.0';
