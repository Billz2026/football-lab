...
function ensureStyles() {
  ...
  style.id = STYLE_ID;
  style.textContent = `
  .version-chip{font-size:0!important}.version-chip::after{content:'V0.4.9';font-size:11px}.footer-build{font-size:0!important}.footer-build::after{content:'V0.4.9 · TACTICS UX';font-size:10px}
  ...
  .v048-workspace{grid-template-columns:minmax(330px,.84fr) minmax(560px,1.16fr);gap:8px;min-height:0}.v048-squad,.v048-board{border:1px solid #23558e;border-radius:0;background:#041429}.v048-squad{grid-template-rows:auto 1fr}.v048-squad-head{padding:7px 9px;border-bottom:1px solid #23558e;background:#0a2242;color:#f4c342}.v048-squad-list{display:grid;grid-template-rows:repeat(20,minmax(0,1fr));overflow:hidden;max-height:none}.v048-squad-row{min-height:0;padding:2px 8px;border-bottom:1px solid rgba(90,160,225,.2);background:#071c38;color:#eef3f6}.v048-squad-row:nth-child(even){background:#0a2242}.v048-squad-row:hover,.v048-squad-row.is-picked,.v048-squad-row.is-selected{background:#174d36}.v048-pos{color:#f4c342}.v048-name strong{font-size:10px}.v048-name small,.v048-condition small{color:#9caebe}.v048-condition strong{color:#eef3f6}.v048-board{grid-template-rows:auto minmax(0,1fr) auto}.v048-instructions{min-height:0;padding:7px 9px;border-bottom:1px solid #23558e;background:#071c38}.v048-instruction-panel{gap:6px}.v048-instruction-title{color:#f4c342}.v048-help{color:#9caebe}.v048-pitch{min-height:0;aspect-ratio:1.42/1;margin:8px;border:2px solid #2d8a4e;background:repeating-linear-gradient(90deg,#0b4b1d 0 12.5%,#0d5521 12.5% 25%)}.v048-pitch:before,.v048-pitch:after{border-color:rgba(238,243,246,.5)}.v048-centre-circle{width:15%;height:auto;aspect-ratio:1}.v048-player{width:96px;min-height:40px;padding:4px 5px;border:1px solid #55dc7c;border-radius:0;background:#071c38ee;box-shadow:0 3px 9px #0009}.v048-player .slot{color:#f4c342}.v048-player strong{font-size:9px}.v048-player small{margin-top:1px;color:#9caebe;font-size:7px}.v048-player.is-drop{background:#174d36}.v048-board-footer{min-height:0;padding:7px 9px;border-top:1px solid #23558e;background:#071c38}.v048-role-editor{display:none}.v048-legend{display:none}.v048-match-sheet-head{display:flex;justify-content:space-between;align-items:center;padding:7px 9px;border-bottom:1px solid #23558e;background:#0a2242;color:#f4c342;font-size:8px;font-weight:950;letter-spacing:.09em}.v048-match-sheet-head span:last-child{color:#9caebe;font-size:7px}.v048-section-label{padding:5px 8px;color:#f4c342;background:#061326;font-size:8px;font-weight:950;letter-spacing:.1em}.v048-bench-divider{border-top:1px solid #23558e}.v048-formation-slot{color:#9caebe;font-size:8px;font-weight:950}.v048-squad-row.is-picked .v048-formation-slot{color:#8ee7a8}.v048-squad-row[data-v048-bench-player]{cursor:grab}.v048-squad-row.is-drop{outline:1px solid #f4c342;outline-offset:-1px}.v048-squad-row .v048-name small{display:block}.v048-clear{border-color:#c36b55!important;color:#ffd0c0!important;background:#391c22!important}
  ...
  .v048-compact-controls{display:flex;align-items:center;gap:5px}.v048-compact-controls .v048-segment{display:flex}.v048-compact-controls .v048-segment button{padding:0 9px}.v048-squad{grid-template-rows:1fr}.v048-squad-list{grid-template-rows:auto repeat(11,minmax(0,1fr)) auto repeat(9,minmax(0,1fr))}.v048-squad-row{grid-template-columns:42px minmax(0,1fr) 64px}.v048-squad-row .v048-name small{font-size:7px}.v048-section-label{min-height:22px}.v048-match-sheet-head{min-height:28px}
  `;
...
function buildTactics(root, c, db) {
  ...
  function squadHtml() {
    ...
    const bench = benchPlayers.map(player => {
      ...
      return `<button type="button" draggable="true" class="v048-squad-row ${selectedPlayerId===player.id?'is-selected':''}" data-v048-squad-player="${esc(player.id)}" data-v048-bench-player="1"><span class="v048-formation-slot">SUB</span><span class="v048-name"><strong>${esc(player.name)}${keyIds.has(player.id)?'<i class="v048-star">★</i>':''}</strong><small>${esc(player.primaryPosition || '—')}</small></span><span class="v048-condition"><strong>${status.condition}%</strong><small>${status.sharpness}% sharp</small></span></button>`;
    }).join('');
