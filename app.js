// Football Lab V40.1 premium pitch
function registerFootballLabServiceWorker() {
  if (!("serviceWorker" in navigator) || !/^https?:$/.test(location.protocol)) return;
  navigator.serviceWorker.register("./sw.js?v=40.1.0", {
    scope: "./",
    updateViaCache: "none"
  })
...
const runtimeEntry = runtimeCaptureMode
  ...
  : "./game/runtime-v23-main.js?v=40.1.0";
...
const bootPromise = runtimeCaptureMode
  ...
  : runtimePromise
      ...
      .then(() => import("./game/keeper-visuals-v38-1.js?v=40.1.0"))
      .then(() => import("./game/flight-v33.js?v=40.1.0"))
      ...
      .then(() => {
        document.documentElement.dataset.footballLabBuild = "40.1.0";
        const badge = document.querySelector(".build-badge-v22");
        if (badge) {
          badge.textContent = "V40.1";
          badge.title = "Football Lab build 40.1.0";
        }
        const version = document.querySelector(".settings-version-v22 strong");
        if (version) version.textContent = "40.1.0";
