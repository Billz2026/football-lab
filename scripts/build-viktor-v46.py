...
def create_animations(armature):
    ...
    clips = {
        ...
        "plant": [
            (1, {"LeftUpperLeg": (12, 0, 0), "LeftLowerLeg": (9, 0, 0), "RightUpperLeg": (-18, 0, 0), "RightLowerLeg": (32, 0, 0), "Chest": (7, 0, -5)}, {}),
            (14, {"LeftUpperLeg": (-8, 0, 0), "LeftLowerLeg": (18, 0, 0), "LeftFoot": (-5, 0, 0), "RightUpperLeg": (-30, 0, 0), "RightLowerLeg": (48, 0, 0), "Chest": (8, 0, -8), "Hips": (2, 0, -5)}, {}),
            (24, {"LeftUpperLeg": (-10, 0, 0), "LeftLowerLeg": (20, 0, 0), "LeftFoot": (-7, 0, 0), "RightUpperLeg": (-38, 0, 0), "RightLowerLeg": (58, 0, 0), "Chest": (8, 0, -10), "Hips": (2, 0, -7)}, {}),
        ],
        "windup": [
            (1, {"LeftUpperLeg": (-10, 0, 0), "LeftLowerLeg": (20, 0, 0), "RightUpperLeg": (-38, 0, 0), "RightLowerLeg": (58, 0, 0), "Chest": (8, 0, -10), "LeftUpperArm": (14, -4, -18), "RightUpperArm": (-18, 3, 20)}, {}),
            (14, {"LeftUpperLeg": (-12, 0, 0), "LeftLowerLeg": (22, 0, 0), "RightUpperLeg": (-58, -4, 3), "RightLowerLeg": (78, 0, 0), "Chest": (10, -3, -18), "Hips": (3, 0, -12), "LeftUpperArm": (20, -5, -24), "RightUpperArm": (-24, 4, 28)}, {}),
            (24, {"LeftUpperLeg": (-12, 0, 0), "LeftLowerLeg": (22, 0, 0), "RightUpperLeg": (-64, -5, 4), "RightLowerLeg": (84, 0, 0), "Chest": (11, -4, -22), "Hips": (3, 0, -15), "LeftUpperArm": (22, -6, -28), "RightUpperArm": (-26, 5, 32)}, {}),
        ],
        "contact": [
            (1, {"LeftUpperLeg": (-12, 0, 0), "LeftLowerLeg": (22, 0, 0), "RightUpperLeg": (-48, -4, 4), "RightLowerLeg": (72, 0, 0), "Chest": (10, -3, -18), "Hips": (3, 0, -12)}, {}),
            (12, {"LeftUpperLeg": (-15, 0, 0), "LeftLowerLeg": (20, 0, 0), "LeftFoot": (-8, 0, 0), "RightUpperLeg": (38, -2, 3), "RightLowerLeg": (8, 0, 0), "RightFoot": (-12, 0, 0), "Chest": (14, 1, 15), "Hips": (4, 0, 12), "LeftUpperArm": (-8, 0, 20), "RightUpperArm": (18, 0, -24)}, {}),
            (24, {"LeftUpperLeg": (-12, 0, 0), "LeftLowerLeg": (18, 0, 0), "RightUpperLeg": (56, 1, 4), "RightLowerLeg": (18, 0, 0), "RightFoot": (-8, 0, 0), "Chest": (16, 2, 21), "Hips": (4, 0, 17), "LeftUpperArm": (-14, 0, 26), "RightUpperArm": (22, 0, -30)}, {}),
        ],
        "follow-through": [
            (1, {"LeftUpperLeg": (-12, 0, 0), "LeftLowerLeg": (18, 0, 0), "RightUpperLeg": (56, 1, 4), "RightLowerLeg": (18, 0, 0), "Chest": (16, 2, 21), "Hips": (4, 0, 17)}, {}),
            (12, {"LeftUpperLeg": (-10, 0, 0), "LeftLowerLeg": (14, 0, 0), "RightUpperLeg": (78, 4, 7), "RightLowerLeg": (28, 0, 0), "Chest": (19, 3, 28), "Hips": (5, 0, 22), "LeftUpperArm": (-18, 0, 30), "RightUpperArm": (28, 0, -34)}, {}),
            (24, {"LeftUpperLeg": (-6, 0, 0), "LeftLowerLeg": (10, 0, 0), "RightUpperLeg": (62, 2, 5), "RightLowerLeg": (34, 0, 0), "Chest": (14, 2, 22), "Hips": (3, 0, 17), "LeftUpperArm": (-12, 0, 22), "RightUpperArm": (20, 0, -26)}, {}),
        ],
        "recovery": [
            (1, {"RightUpperLeg": (48, 1, 3), "RightLowerLeg": (30, 0, 0), "Chest": (12, 2, 18), "Hips": (2, 0, 12)}, {}),
            (12, {"RightUpperLeg": (14, 0, 1), "RightLowerLeg": (16, 0, 0), "LeftUpperLeg": (-4, 0, 0), "Chest": (6, 1, 8), "Hips": (1, 0, 5)}, {}),
            (24, neutral, {}),
        ],
    }
    created = []
