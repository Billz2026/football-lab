...
const checks = [
  ...
  ["app lazy-loads the canonical duel", source.app.includes(`penalty-duel-v51.js?v=\${RELEASE_BUILD}`)],
  ["app lazy-loads the canonical transition guard", source.app.includes(`penalty-duel-transition-guard-v51.js?v=\${RELEASE_BUILD}`)],
