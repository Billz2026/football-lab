...
const replacement = `const VENUE_THEMES = Object.freeze({
...
function drawBackground() {
  ...
  // V40.3A: every campaign chapter now has a genuinely different stadium scale and structure.
  ...
  // Rails and fascia define separate physical stadium planes.
  ...
  // Venue identity sits above the keeper lane, never through the goalkeeper.
